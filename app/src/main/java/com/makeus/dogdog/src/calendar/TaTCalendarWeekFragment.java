...
import com.makeus.dogdog.widget.TaTCalendarWeekView;
...
public class TaTCalendarWeekFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        calendarView =  mRootView.findViewById(R.id.calendarweekview);
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(timeByMillis);

        for (int i = 0; i < 14; i++) {
            com.makeus.dogdog.widget.TaTCalendarWeekItemView child = new com.makeus.dogdog.widget.TaTCalendarWeekItemView(getActivity().getApplicationContext());
