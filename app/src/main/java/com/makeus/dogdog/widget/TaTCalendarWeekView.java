package com.makeus.dogdog.widget;
...
public class TaTCalendarWeekView extends ViewGroup {
    ...
    public TaTCalendarWeekView(Context context, AttributeSet attrs) {
        ...
        DAY_OF_WEEK = getResources().getStringArray(R.array.weekly);
    }
            ...
            if (tagView != null) {
                ...
                for (int i = 0; i < pager.getChildCount(); i++) {
                    for (int j = 0; j < getChildCount(); j++) {
                        com.makeus.dogdog.widget.TaTCalendarWeekItemView child = (com.makeus.dogdog.widget.TaTCalendarWeekItemView) ((TaTCalendarWeekView) pager.getChildAt(i)).getChildAt(j);
                        if (child == null) {
                            continue;
                        }
